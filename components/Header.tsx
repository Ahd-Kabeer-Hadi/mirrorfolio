  ...
  return (
    <>
      <header className="relative z-[999] hidden px-4 md:block">
        <div className="container mx-auto mt-8 flex h-16 w-full m-auto sticky top-5 max-w-[1024px] items-center justify-between rounded-xl border-[1px] border-white/25 bg-white/25 px-4 backdrop-blur-md dark:border-card-border/20 dark:bg-[#18181D]/30">
